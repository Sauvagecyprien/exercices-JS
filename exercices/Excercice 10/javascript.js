...
<!-- Faites un jeu de pétanque -->
<!-- Le jeu se jouera à deux -->
<!-- Pour simplifier le jeu, il n'y aura qu'une seule manche -->
<!-- Le cochonnet doit être placé aléatoirement entre 5 et 8 mètre -->
<!-- Vous lancerez la boule de pétanque en choisissant la force utilisée ( 1 - 10 ) une puissance de 3 enverra la boule entre 2,50 mètre et 3,00 mètre au hasard -->
<!-- Le plus proche du cochonnet gagne -->
<!-- Néanmoins si le joueur 2 lance et qu'il se retrouve à moins de 15 cm de l'autre joueur alors on considère que la boule de l'autre joueur est poussé de 17cm -->
*/


function jeudepetanque() {

var joueurun ;
var joueurdeux ; 
var cochonnet ; 
/*var valeur = Math.round(Math.random(1,10));*/
var valeurun ; 
var valeurdeux ;
var x = Math.random(valeurun-0.5,valeurun);
var y = Math.random(valeurdeux-0.5,valeurdeux);

cochonnet = Math.round(Math.random(5)+3);
 valeurun = prompt('le cochonnet à etait lancé a : '+cochonnet +' \n joueur 1 : a quelle puissance doit on lancer la boule entre 1 et 10 ?');
 valeurdeux = prompt('le cochonnet à etait lancé a : '+cochonnet +' \n joueur 2 : a quelle puissance doit on lancer la boule entre 1 et 10 ?');
 

if (cochonnet-x > cochonnet-y ) {
    alert('le joueur 2 gagne');
}else if (cochonnet-y > cochonnet-x) {
